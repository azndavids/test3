...
<br><br><br><br>
<center>
	<div class="card-header bg-danger mb-3" align="center" style="width: 300px">(TEAM) TM CASES</div>
</center>
<div class="row">
...
<div class="row justify-content-center">
	<div class="col-md-12">
		<div class="card-header bg-danger mb-3 sticky text-white" align="center">(TEAM) TM CASES</div>
